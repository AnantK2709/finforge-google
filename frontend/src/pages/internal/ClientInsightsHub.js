          ...
          <div className="insights-columns">
            ...
            <motion.div className="column-right" variants={itemVariants}>
              {isLoading ? (
                ...
                <>
                  <motion.div 
                    className="behavioral-profile-card"
                    variants={itemVariants}
                  >
                    ...
                    <div className="risk-tolerance-section">
                      ...
                      <div className="tolerance-wrapper">
                        <div className="tolerance-meter">
                          <div 
                            ...
                            style={{ width: `${(behavioralInsights.riskTolerance.score / 10) * 100}%` }}
                          ></div>
                        </div>
                      ...
                      <div className="tolerance-info">
                        ...
                        <div className="tolerance-details">
                          <span className="tolerance-category">{behavioralInsights.riskTolerance.category}</span>
                          <p className="tolerance-description">{behavioralInsights.riskTolerance.description}</p>
                        </div>
                      </div>
                    </div>
                        ...
                        <div key={index} className={`timeline-item ${event.sentiment}`}>
                          ...
                          <div className="timeline-content">
                            ...
                            <div className="timeline-sentiment">
                              <i className={`fas ${
                                event.sentiment === 'confident' ? 'fa-smile' :
